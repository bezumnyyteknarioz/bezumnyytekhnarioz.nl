function changeLanguage() {
    ...
    if (language === "en") {
        ...
        document.querySelector("#home p").innerText = "Ми надаємо послуги з установки, заміни та обHere is an enhanced version of the website code that incorporates:

1. **Beautiful background and smooth animations**.
2. **Multiple pages** for services, projects, offers, and contact information.
3. **Mobile responsiveness** for both Android and iOS devices.
4. **Language selector** (Dutch, English, Ukrainian, Russian).
5. **Dynamic animations** and a polished design.

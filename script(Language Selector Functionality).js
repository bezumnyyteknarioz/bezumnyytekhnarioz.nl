function changeLanguage() {
    ...
    if (language === "en") {
        ...
        document.querySelector("#home p").Here’s an updated version of your website that includes:

1. **A beautiful gradient background** with smooth animations for the sections.
2. **Multiple pages** for services, projects, offers, and contact details.
3. **Mobile responsiveness** to adjust the layout for smaller devices (Android/iOS).
4. **Language selector** to switch between Dutch, English, Ukrainian, and Russian.

### Full Breakdown:

#### **index.html**
This file contains the structure of your website, with sections for home, services, projects, offers, and contact, each featuring smooth animations when scrolling into view. The navigation menu allows users to easily access the various sections, and the language selector lets them switch between Dutch, English, Ukrainian, and Russian.
